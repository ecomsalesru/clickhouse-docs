...
|`version`|`Int64`||
|`autoAdType`|`LowCardinality(String)`||
...
|`prevNmFeedbacks`|`Int32`||
|`nmFeedbacksDiff`|`Int32`||
...
|`feedbacksCountWithNoAnswer`|`Int32`||
|`lastNegativeFeedbackPosition`|`Int32`||
|`lastNegativeFeedbacksCount`|`Int32`||
|`etag`|`String`||
...
Динамика остатков, разница между было/стало. До скрытия остатков со стороны ВБ это было удобным инструментом для приблизительного анализа продаж конкурентов.
Частота обновлнений остатков динамический. Есть 4 группы товаров, которые делятся относительно количества новых отзывов за 30 дней:
    1) `HIGH`, новых отзывов от 300 и более, парсинг каждый 30 секунд
    2) `PRE_HIGH`, отзывов от 30 и до 299, парсинг каждые 10 минут
    3) `MEDIUM`, отзывов от 3 и до 29, парсинг каждый час
    4) `LOW`, отзывов меньше 3, парсинг каждые 8 часов
примерно раз в сутки эти группы пересматриваются, относительно таблицы productStats

|имя столбца|Тип|Описание|
|--|--|--|
|`id`|`Int32`|Артикул(айди) товара|
|`parsedAt`|`DateTime`|Дата парсинга|
|`stocks.optionId`|`Array(Int32)`|Массив идентификаторов размеров, текущее состояние|
|`stocks.wh`|`Array(Int32)`|Массив идентификаторов складов, текущее состояние|
|`stocks.qty`|`Array(Int32)`|Массив остатков, текущее состояние|
|`stocks.price`|`Array(Int32)`||
|`prev.optionId`|`Array(Int32)`|Массив идентификаторов размеров, прошлое состояние|
|`prev.wh`|`Array(Int32)`|Массив идентификаторов складов, прошлое состояние|
|`prev.qty`|`Array(Int32)`|Массив остатков, прошлое состояние|
|`prev.price`|`Array(Int32)`|Массив цен, прошлое состояние|
|`diff.optionId`|`Array(Int32)`|Массив идентификаторов размеров, разница между прошлым и текущим|
|`diff.wh`|`Array(Int32)`|Массив идентификаторов складов|
|`diff.qty`|`Array(Int32)`|Массив разниц остатков между прошлым и текущим. +1 - заказ, -1 - возврат|
|`diff.price`|`Array(Int32)`|Массив цен, последнее состяние(текущая цена, если нет то прошлая цена)|
|`diff.stocks`|`Array(Int32)`|Массив остатков, последнее состяние|
|`clientSale`|`Int32`||
|`price`|`Int32`|Цена первого размера|
|`prevParsedAt`|`DateTime`||
|`subjectId`|`Int32`||
|`sellerId`|`Int32`||
|`brandId`|`Int32`||
|`parseGroup`|`LowCardinality(String)`||
